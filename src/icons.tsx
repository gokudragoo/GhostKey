...
import IconLayoutSidebarLeftExpand from "@tabler/icons-react/dist/esm/icons/IconLayoutSidebarLeftExpand.mjs";
...
export const SidebarCollapse = icon(IconLayoutSidebarLeftCollapse);
export const SidebarExpand = icon(IconLayoutSidebarLeftExpand);
